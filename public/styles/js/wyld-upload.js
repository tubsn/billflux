class fl_fileUploader extends HTMLElement {
	...
	styleElement() {
		...
		this.innerHTML =
		`<form id="${randomID}" class="fl-upload-form" action="${this.destination}" style="display:none" method="post" enctype="multipart/form-data" accept-charset="utf-8">
...
class fl_uploads {
	...
	constructor(form,buttons) {
		...
		this.buttons = this.form.querySelectorAll(buttons);
