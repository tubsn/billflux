...
class BlankLayout extends htmlView {
	...
	public $description = 'Teh wylde data storage solution!';
	...
	public $framework = ['/styles/js/vendors/vue34.min.prod.js','/styles/flundr/components/fl-dialog.js', '/styles/js/wyld-upload.js' , '/styles/js/vendors/photoswipe-lightbox.umd.min.js', '/styles/js/vendors/photoswipe.umd.min.js', '/styles/js/components/vue-upload.js'];
	public $meta = [
		'author' => 'flundr',
	...
	public $templates = [
		...
		'header' => 'navigation/customer-nav',
		'main' => null,
		'footer' => null,
